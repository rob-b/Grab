...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('feeds_feed', 'etag', models.CharField(_('etag'), max_length=50, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feed.etag'
        db.alter_column('feeds_feed', 'etag', models.CharField(_('etag'), max_length=50, null=True, blank=True))
